        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('car.update', ['car' => $mycar->id]) }}" method="post"
                        ...
                        <div class="relative z-0 w-full mb-5 group">
                            <input type="text" name="matricula" id="matricula"
                                value="{{ old('precio', $mycar->matricula) }}"
                        ...
                        <div class="relative z-0 w-full mb-5 group">
                            <input type="year" name="anio" id="anio"
                                value="{{ old('precio', $mycar->anio) }}"
                                class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                placeholder=" " required />
                            <label for="anio"
                        ...
                        <div class="relative z-0 w-full mb-5 group">
                            <input type="date" name="fecha_ultima_revision" id="fecha_ultima_revision"
                                value="{{ old('precio', $mycar->fecha_ultima_revision) }}"
                                class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                placeholder=" " required />
                        ...
                        <div class="relative z-0 w-full mb-5 group">
                            <input type="file" name="foto" id="foto" value="{{ old('foto', $mycar->foto) }}"
                                class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                placeholder=" " />
                            <img src="{{ asset($ruta . $mycar->foto) }}" width="20%" alt="">
                            <label for="foto"
