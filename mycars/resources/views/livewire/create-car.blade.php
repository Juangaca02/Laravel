<div>
    ...
    <button type="button" wire:click='mostrarForm()'
        class="text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">Añadir
        Coche</button>
    ...
    @if ($mostrar)
        <form wire:submit='guardar()' enctype="multipart/form-data" class="max-w-md mx-auto">
            ...
            <div class="relative z-0 w-full mb-5 group">
                <input type="text" name="matricula" id="matricula" wire:model.blur='matricula'
            ...
            <div class="relative z-0 w-full mb-5 group">
                <input type="text" name="modelo" id="modelo" wire:model='modelo'
                    class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                    placeholder=" " required />
                <label for="modelo"
            ...
            <div class="relative z-0 w-full mb-5 group">
                <input type="year" name="anio" id="anio" wire:model='anio'
                    class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                    placeholder=" " required />
                <label for="anio"
            ...
            <div class="relative z-0 w-full mb-5 group">
                <input type="date" name="fecha_ultima_revision" id="fecha_ultima_revision"
                    wire:model='fecha_ultima_revision'
                    class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                    placeholder=" " required />
            ...
            <div class="relative z-0 w-full mb-5 group">
                <input type="file" name="foto" id="foto" wire:model='foto'
                    class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                    placeholder=" " required />
                <label for="foto"
