<div class="ml-4">
    @if ($this->profile_photo_path)
        ...
        <img class="w-56 max-h-56 max-w-56 min-h-56 min-w-56 mx-auto" src="{{ $this->profile_photo_path->temporaryUrl() }}"
            alt="">
    @else
    ...
    <form action="{{ route('profile.updatePhoto') }}" method="POST" class="grid grid-cols-1"
        ...
        <label for="profile_photo_path"
            ...
            <input type="file" wire:model="profile_photo_path" id="profile_photo_path" name="profile_photo_path" class="hidden">
        </label>
