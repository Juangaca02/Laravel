                            ...
                            <td
                                ...
                                <button class="BtnDetalles m-2 min-w-[90px]">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        ...
                                        onclick="showCountryDetails({{ $Countries->id }})">
                                ...
                                @if (Auth::user()->rol_id == 2)
                                    <a href="{{ route('editCountry', ['id' => $Countries->id]) }}">
                                        <button class="BtnEdit m-2 min-w-[90px]">
                                            Edit
                                    ...
                                    <form action="/deleteCountry/{{ $Countries->id }}" method="delete" class="m-1">
                                        @csrf
                                        @method('delete')
                                        <button class="btn_deleteUser rounded-xl" type="button"
                                            onclick="confirmDelete({{ $Countries->id }}, 'el pais {{ $Countries->name }}','country')">
                                ...
                                @else
                                    @if (Auth::user()->range_id >= 11)
                                        ...
                                        <form action="/deleteCountry/{{ $Countries->id }}" method="delete"
                                            class="m-1">
                                            @csrf
                                            @method('delete')
                                            <button class="btn_deleteUser rounded-xl" type="button"
