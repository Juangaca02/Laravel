                ...
                <form class="bg-opacity-50 backdrop-blur-md p-8 rounded-lg shadow-md w-full max-w-4xl flex"
                    ...
                    <div class="w-full flex">
                        <div class="">
                            ...
                            <table>
                                <tr>
                                    <td>
                                        ...
                                        <input type="text" name="title" id="title"
                                            value="{{ $mission->title }}" class="form-input mt-1 block w-full">
                                    </td>
                                    <td>
                                        <!-- Subtítulo -->
                                        <label for="subtitle" class="block text-black font-bold">Subtítulo</label>
                                        <input type="text" name="subtitle" id="subtitle"
                                            value="{{ $mission->subtitle }}" class="form-input mt-1 block w-full">
                                    </td>
                                    <td>
                                        <!-- Fecha -->
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="text" name="priority" id="priority"
                                            value="{{ $mission->priority }}" class="form-input mt-1 block w-full">
                                    </td>
                                    <td>
                                        <!-- Objetivo -->
                                        <label for="objective" class="block text-black font-bold">Objetivo</label>
                                        <input type="text" name="objective" id="objective"
                                            value="{{ $mission->objective }}" class="form-input mt-1 block w-full">
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        ...
                                        <input type="text" name="action" id="action"
                                            value="{{ $mission->action }}" class="form-input mt-1 block w-full">
                                    </td>
                                    <td>
                                        <!-- Resultado -->
                                        <label for="result" class="block text-black font-bold">Resultado</label>
                                        <input type="text" name="result" id="result"
                                            value="{{ $mission->result }}" class="form-input mt-1 block w-full">
                                    </td>
                                    <td>
                                        <!-- Ejército -->
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <!-- Usuario -->
                                        <label for="user_id" class="block text-black font-bold">Usuario</label>
                                    ...
                                    <td>
                                        ...
                                        <input type="text" name="status" id="status"
                                            value="{{ $mission->status }}" class="form-input mt-1 block w-full">
                                    </td>
                                </tr>
                            </table>
                        </div>
                        <div class="">
                            ...
                            <textarea name="description" id="description" cols="30" rows="10" class="form-input mt-1 block w-full">{{ $mission->description }}</textarea>
                        </div>
                        <div>
                            <!-- Foto -->
                            <label for="photo" class="block text-black font-bold mt-4">Foto</label>
