    ...
    <div
        ...
        <div class="relative flex flex-col sm:flex-row mt-6 shadow-md overflow-hidden sm:rounded-lg bg-cover bg-center h-[550px] w-[1100px]"
            ...
            <div
                ...
                <p class="text-4xl font-medium font-['Montserrat']">Ingresa para acceder a información vital y recursos
                    estratégicos.</p>
                <p>¿No tienes una cuenta?</p>
                <button class="buttonLogin mt-5">
                    <span class="text"><a href="{{ route('register') }}">{{ __('Registrarse') }}</a></span>
                </button>
            </div>

            <div class="relative flex flex-col text-white justify-center items-center w-full sm:w-1/2 bg-opacity-80 backdrop-blur-md rounded-r-lg p-5 shadow-md"
                style="box-shadow: -5px 0 15px rgba(0, 0, 0, 0.5);">

                <p class="text-6xl font-medium font-['Montserrat']">Login</p>
