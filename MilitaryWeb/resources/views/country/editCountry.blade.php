<x-pagina-sin-nada-layout navbarType="black">
    <div class="relative h-screen overflow-hidden">
        <figure class="w-full h-full">
            <img src="{{ asset('/storage/Images/images-Country/editCountry.png') }}" alt=""
        ...
        <div class="absolute inset-0 flex flex-col items-center justify-center space-y-2">
            ...
            <div class="flex space-x-5">
                <form class="bg-opacity-50 backdrop-blur-md p-4 rounded-lg shadow-md w-auto max-w-[1600px]"
                    enctype="multipart/form-data" method="post" action="{{ route('updateCountry') }}" >
                    <div class="w-full flex">
                        <div class="flex flex-col">
                            ...
                            <div class="flex items-center p-2">
                                ...
                                <input type="text" name="nombre" id="nombre" value="{{ $country->name }}" class="form-input mt-1 block">
                            </div>
                            <div class="flex items-center p-2">
                                <!-- Descripción -->
                                ...
                                <textarea name="descripcion" id="descripcion" cols="30" rows="5" class="form-input mt-1 block">{{ $country->description }}</textarea>
                            </div>
                        </div>
                    </div>
